    ...
    return (
        ...
        >
            ...
            <ContentWrapper 
                {...(href && { href })}
                className={cn(
                    "text-sm text-neutral-600 relative z-10 px-8",
                    href && "hover:text-emerald-600 transition-colors cursor-pointer"
                )}
            >
                {content}
            </ContentWrapper>
...
export default function ContactSection() {
    ...
    return (
        <section id="contact" className="py-20 bg-background text-foreground relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/50 via-transparent to-blue-50/50 pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="flex flex-col items-center gap-6 text-center mb-16">
                    ...
                    <h2 className="relative z-10 inline-block bg-gradient-to-r from-neutral-900 via-neutral-700 to-neutral-900 bg-clip-text text-4xl font-bold leading-tight text-transparent sm:text-5xl">
                        Get in Touch
                    </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-2 grid grid-cols-1 relative z-10 bg-white rounded-2xl border border-neutral-200 shadow-lg shadow-neutral-200/50 overflow-hidden">
                    ...
                    <div className="lg:col-span-3 relative">
                        ...
                        <div className="relative bg-white p-8 rounded-2xl border border-neutral-200 shadow-lg shadow-neutral-200/50 flex flex-col justify-center">
                                ...
                                <div className="relative">
                                    ...
                                    <div className={cn(
                                        ...
                                        <textarea
                                            id="message"
                                            rows={4}
                                            className="w-full rounded-xl border border-neutral-300 shadow-sm focus:border-emerald-500 focus:ring-0 focus:outline-none bg-neutral-50 text-neutral-900 p-4 transition-all resize-none"
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {["Product Inquiry", "Bulk Order", "Distribution"].map((quick) => (
                                        <button
                                            ...
                                            className="px-3 py-1.5 text-sm rounded-full bg-neutral-100 text-neutral-600 hover:bg-emerald-100 hover:text-emerald-700 transition-colors border border-neutral-200"
                                        >
                                            {quick}
                                        </button>
                                    ))}
