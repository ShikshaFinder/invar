...
export default function Home() {
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 font-sans">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-2">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-80 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-neutral-200/50 dark:border-neutral-800/50 p-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top translate-y-2 group-hover:translate-y-0">
                    <div className="space-y-4">
                      <div className="p-3 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/50 dark:to-teal-950/50">
                ...
                <div className="relative group">
                  ...
                  {/* Dropdown Content - Glassmorphic */}
                  <div className="absolute top-full right-0 mt-2 w-72 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-neutral-200/50 dark:border-neutral-800/50 p-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top-right translate-y-2 group-hover:translate-y-0">
                    <div className="flex flex-col gap-2">
                      <a href="tel:+917096273336" className="flex items-center p-3 rounded-xl hover:bg-emerald-50 dark:hover:bg-emerald-950/50 transition-all group/item">
                        <div className="bg-gradient-to-br from-emerald-100 to-emerald-200 dark:from-emerald-900 dark:to-emerald-800 p-2.5 rounded-xl mr-3 text-emerald-600 dark:text-emerald-400 shadow-sm">
                        ...
                        <div>
                          ...
                          <span className="text-sm font-bold text-neutral-900 dark:text-neutral-100 group-hover/item:text-emerald-600 transition-colors">+91 70962 73336</span>
                        </div>
                      </a>

                      <a href="mailto:invarpharma@gmail.com" className="flex items-center p-3 rounded-xl hover:bg-blue-50 dark:hover:bg-blue-950/50 transition-all group/item">
                        <div className="bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 p-2.5 rounded-xl mr-3 text-blue-600 dark:text-blue-400 shadow-sm">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                          ...
                          <span className="text-sm font-bold text-neutral-900 dark:text-neutral-100 group-hover/item:text-blue-600 transition-colors">invarpharma@gmail.com</span>
                        </div>
                      </a>
                    </div>
                  </div>
      ...
      <section id="products" className="py-24 bg-white dark:bg-neutral-900 relative overflow-hidden">
        {/* Background Gradient */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.filter(p => p.family !== "CATALOG").map((product, index) => (
              ...
              >
                ...
                {product.image && (
                  <div className="relative w-full h-48 mb-6 overflow-hidden rounded-2xl bg-gradient-to-br from-neutral-100 to-neutral-50 dark:from-neutral-800 dark:to-neutral-900">
                    <Image
                      src={product.image}
                      alt={product.title}
                      fill
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-xs font-bold tracking-wider text-emerald-600 dark:text-emerald-400 uppercase px-3 py-1 bg-emerald-50 dark:bg-emerald-900/30 rounded-full">
                      {product.family}
                    </span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="space-y-4">
            {products.filter(p => p.family !== "CATALOG").map((product, index) => (
              <div 
                key={index} 
                className="group relative flex flex-col lg:flex-row items-start lg:items-center justify-between bg-white dark:bg-neutral-900 p-6 lg:p-8 rounded-2xl border border-neutral-200 dark:border-neutral-800 hover:border-emerald-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/5"
              >
                {/* Left accent line */}
                ...
                <div className="flex-1 pl-4 mb-4 lg:mb-0">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wide px-2.5 py-1 bg-emerald-50 dark:bg-emerald-900/30 rounded-md">
                      {product.family}
                    </span>
                  </div>
                  <h3 className="text-xl font-bold text-neutral-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors mb-2">
                    {product.title}
                  </h3>
                  <p className="text-neutral-600 dark:text-neutral-400 text-sm max-w-2xl mb-4">
                    {product.description}
                  </p>
                  {product.features && (
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {product.features.slice(0, 4).map((feature, i) => (
                        <li key={i} className="flex items-center text-sm text-neutral-600 dark:text-neutral-400">
      ...
      <section className="py-24 bg-neutral-50 dark:bg-neutral-950 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {ingredients.map((ingredient, index) => (
              <a 
                href={`/benefits/${index}`} 
                key={index} 
                className="group relative bg-white dark:bg-neutral-900 rounded-3xl overflow-hidden border border-neutral-200 dark:border-neutral-800 hover:border-blue-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10"
              >
                {/* Image Section */}
                {ingredient.image ? (
                  <div className="relative w-full h-56 overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/50 dark:to-indigo-950/50">
                    <Image
                ...
                {/* Content Section */}
                <div className="p-6">
                  <h3 className="text-lg font-bold text-neutral-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                    {ingredient.name}
                  </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {useCases.map((useCase, index) => (
              <div 
                key={index} 
                className="group relative bg-gradient-to-br from-white to-neutral-50 dark:from-neutral-800 dark:to-neutral-900 p-8 rounded-3xl border border-neutral-200 dark:border-neutral-700 hover:border-purple-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/10 overflow-hidden"
              >
                {/* Background pattern */}
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -translate-y-1/2 translate-x-1/2" />
                ...
                <div className="flex items-start gap-6 relative z-10">
                  <div className="flex-shrink-0">
                    <div className="relative">
                      ...
                      <div className="relative bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/50 dark:to-pink-900/50 p-4 rounded-2xl text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300">
