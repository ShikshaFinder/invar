...
export const PricingCard = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col items-center border-b pb-6 border-zinc-200">
          <span className="mb-6 inline-block text-zinc-900">
            {tier}
          </span>
          <span className="mb-3 inline-block text-4xl font-medium">
            {price}
          </span>
          <span className=" bg-gradient-to-br from-zinc-700 to-zinc-900 bg-clip-text text-center text-transparent">
            {bestFor}
          </span>
        </div>
